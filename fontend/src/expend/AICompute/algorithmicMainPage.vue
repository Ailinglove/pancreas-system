...
<!--        <img src="./analysis/img/loading3.gif" class="loading" style="" v-show="showimg">-->
...
<!--          -->
<!--&lt;!&ndash;          分类结果：<span style="border-bottom: 1px solid gray">{{result}}</span>&ndash;&gt;-->
...
<script>
  import classfLeft from "./analysis/classfLeft";
  export default {
    name: "algorithmicMainPage",
    components:{
      classfLeft
    },
    data(){
