...
function isModalityLUTForDisplay(sopClassUid) {
  ...
  return sopClassUid !== 'bg.jpg.2.840.10008.5.bg.jpg.4.bg.jpg.bg.jpg.12.bg.jpg' && // XA
  sopClassUid !== 'bg.jpg.2.840.10008.5.bg.jpg.4.bg.jpg.bg.jpg.12.2.bg.jpg'; // XRF
}
...
function decodeImageFrame(imageFrame, transferSyntax, pixelData, canvas) {
  ...
  if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2') {
    // Implicit VR Little Endian
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.bg.jpg') {
    // Explicit VR Little Endian
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.2') {
    // Explicit VR Big Endian (retired)
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.bg.jpg.99') {
    // Deflate transfer syntax (deflated by dicomParser)
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.5') {
    // RLE Lossless
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.50') {
    ...
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.51') {
    // JPEG Baseline lossy process 2 & 4 (12 bit)
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.57') {
    // JPEG Lossless, Nonhierarchical (Processes 14)
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.70') {
    // JPEG Lossless, Nonhierarchical (Processes 14 [Selection 1])
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.80') {
    // JPEG-LS Lossless Image Compression
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.81') {
    // JPEG-LS Lossy (Near-Lossless) Image Compression
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.90') {
    // JPEG 2000 Lossless
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  } else if (transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.91') {
    // JPEG 2000 Lossy
    return processDecodeTask(imageFrame, transferSyntax, pixelData, options);
  }
...
function isJPEGBaseline8BitColor(imageFrame, transferSyntax) {
  ...
  if (imageFrame.bitsAllocated === 8 && transferSyntax === 'bg.jpg.2.840.10008.bg.jpg.2.4.50' && (imageFrame.samplesPerPixel === 3 || imageFrame.samplesPerPixel === 4)) {
    return true;
  }
}
...
function getTransferSyntaxForContentType(contentType) {
  var transferSyntax = 'bg.jpg.2.840.10008.bg.jpg.2'; // Default is Implicit Little Endian.
...
function getModalityLUTOutputPixelRepresentation(dataSet) {
  ...
  if (sopClassUID === 'bg.jpg.2.840.10008.5.bg.jpg.4.bg.jpg.bg.jpg.2' || sopClassUID === 'bg.jpg.2.840.10008.5.bg.jpg.4.bg.jpg.bg.jpg.2.bg.jpg') {
    return 1;
  }
...
exports.default = '2.bg.jpg.bg.jpg';
